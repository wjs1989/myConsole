 ...
 */
package com.wjs.discovery.nacos;
...
import com.wjs.common.util.CollectionUtils;
import com.wjs.common.util.NetUtil;
import com.wjs.common.util.StringUtils;
import com.wjs.discovery.core.Configuration;
import com.wjs.discovery.core.ConfigurationFactory;
import com.wjs.discovery.register.RegistryService;
...
public class NacosRegistryServiceImpl implements RegistryService<EventListener> {
    ...
    private static final String DEFAULT_APPLICATION = "wjs-console";
